    ...
    <>
      ...
      <div className="drillPage">
        ...
        <div className='contentDrill' id='descObsContainer'>
            ...
            {descriptionNotEdited ? <p className='pDrill' style={{margin: "10px 0 20px 0"}}>{description}</p> :  <textarea className='textAreaDrill w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary' onChange={(e) => setDescriptionAux(e.target.value)} maxLength={500} value={descriptionAux}/>}
            <div className='titleLayout'> 
            ...
            {observationsNotEdited ? <p className='pDrill'>{observations}</p> :  <textarea className='textAreaDrill w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary' onChange={(e) => setObservationsAux(e.target.value)} maxLength={500} value={observationsAux}/>}
        </div>
      </div>   
    </>
  );
