...
|       C5       |        F17         |     Adicionar alunos a uma turma     |
|       C5       |        F18         |     Remover alunos de uma turma      |
|       C5       |        F19         |      Editar dados de uma turma       |
|       C5       |        F20         |          Excluir uma turma           |
|       C5       |        F21         |      Visualizar turmas criadas       |
|       C6       |        F22         |     Visualizar agenda das aulas      |
|       C6       |        F23         |      Visualizar alunos da aula       |
|       C6       |        F24         |  Realizar chamada de alunos da aula  |
|       C6       |        F25         |    Notificar ausência em uma aula    |
|       C6       |        F26         | Selecionar dias de reposição da aula |
