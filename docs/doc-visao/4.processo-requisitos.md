...
| 27/9/2023 | 0.2.1 | Refatoração e correção da documentação dos processos de Engenharia de Requisitos | [Artur Rodrigues](https://github.com/ArturRSA19), [João Barreto](https://github.com/JoaoBarreto03) e [Luciano de Freitas](https://github.com/luciano-freitas-melo)|
...
|---|---|---|
| <img src="/assets/icones/discord.svg" width="40" height="40"> | Discord | Realizar as Sprints e Dailies |
...
<p style="display: flex; justify-content: center; font-size: 0.8em">Tabela 2 -  Atividades, Métodos, Ferramentas e Entrega baseados nas Atividades de Engenharia de Requisitos.</p>
...
<p style="display: flex; justify-content: center; font-size: 0.8em">Tabela 3 -  Atividades, Métodos, Ferramentas e Entrega baseados nas Atividades de Engenharia de Requisitos.</p>
...
<p style="display: flex; justify-content: center; font-size: 0.8em">Tabela 4 -  Atividades, Métodos, Ferramentas e Entrega baseados nas Atividades de Engenharia de Requisitos.</p>
...
<p style="display: flex; justify-content: center; font-size: 0.8em">Tabela 5 -  Atividades, Métodos, Ferramentas e Entrega baseados nas Atividades de Engenharia de Requisitos.</p>
